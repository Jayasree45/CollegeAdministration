...
namespace CollegeAdministration.Controllers
{
    ...
    {
        private Training_12DecMumbaiEntities user = new Training_12DecMumbaiEntities();
        ...
        public async Task<ActionResult> Login(LoginViewModel model, string returnUrl)
        {
            ...
            switch (result)
            {
                case SignInStatus.Success:
                    ...
                    {
                        return RedirectToAction("AdminHomePage", "Role");
                    }
                    else
                    if (UserManager.IsInRole(user1.Id, "Staff"))
                    {
                    ...
                    return View(model);
                    //var User1 = user.Students.Find(model.Email);
                    //Session["UserObj"] = User1;
                    //Session["UserObject"] = result;
